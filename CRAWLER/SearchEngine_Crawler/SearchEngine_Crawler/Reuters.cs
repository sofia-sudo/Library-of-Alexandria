...
namespace SearchEngine_Crawler
{
    public class Reuters : Crawler
    {
        ...
        public Reuters ()
        {
            this.homeURL = "https://www.reuters.com/";
            ...
            bannedDomains.Add("/finance/stocks/option");
            bannedDomains.Add("/finance/stocks/financialHighlights");
            bannedDomains.Add("/search");
            bannedDomains.Add("/site-search/");
            bannedDomains.Add("/beta");
            bannedDomains.Add("/designtech*");
            bannedDomains.Add("/featured-optimize");
            bannedDomains.Add("/energy-test");
            bannedDomains.Add("/article/beta");
            bannedDomains.Add("/sponsored/previewcampaign");
            bannedDomains.Add("/sponsored/previewarticle");
            bannedDomains.Add("/test/");
            bannedDomains.Add("/commentary");
            bannedDomains.Add("/news/archive/commentary");
            bannedDomains.Add("/brandfeatures/venture-capital*");
            bannedDomains.Add("/journalists/");
            bannedDomains.Add("/assets/siteindex");
            bannedDomains.Add("/article/api/");
            bannedDomains.Add("/practical-law-the-journal/search/");
            bannedDomains.Add("/practical-law-the-journal/contributors/");

            bannedDomains.Add("/differentiator");
            bannedDomains.Add("#main-content");
            bannedDomains.Add("/signup/");
            bannedDomains.Add("/markets/quote");
            bannedDomains.Add("/lseg");

            // Define the approved domains
            approvedDomains = new List<String>();

            approvedDomains.Add("/markets");
            approvedDomains.Add("/world");
            approvedDomains.Add("/business");
            approvedDomains.Add("/legal");
            approvedDomains.Add("/breakingviews");
            approvedDomains.Add("/technology");
            approvedDomains.Add("/investigates");
            approvedDomains.Add("/lifestyle");
            approvedDomains.Add("");
            approvedDomains.Add("");
            approvedDomains.Add("");
            approvedDomains.Add("");
            ...
            // Debug purposes only
            Program.Cache("https://www.reuters.com/markets/");
            Program.Cache("https://www.reuters.com/world/");
            Program.Cache("https://www.reuters.com/business/");
            Program.Cache("https://www.reuters.com/legal/");
            Program.Cache("https://www.reuters.com/breakingviews/");
            Program.Cache("https://www.reuters.com/technology/");
            Program.Cache("https://www.reuters.com/investigates/");
            Program.Cache("https://www.reuters.com/lifestyle/");
                    ...
                    try
                    {
                        ...
                        if (tag != null)
                        {
                            ...
                            if ( //tag.Attributes["name"].Value.ToUpper() == "OG:DESCRIPTION"
                              tag.Attributes["property"].Value.ToUpper() == "OG:DESCRIPTION" )
            ...
            try
            {
                ...
                if (links != null)
                {
                    foreach (var link in links) // Loop for each link
                    {
                        ...
                        if (!hyperlink.Contains("www.reuters") && !hyperlink.StartsWith("/"))
                        {
                            isInternal = false;
                            externalLinkCount++;
                        }
                        ...
                        if (!Program.cache.Contains(hyperlink) && isInternal)
                        {
                            ...
                            if (!banned)
                            {
                                ...
                                foreach (string domain in approvedDomains)
                                {
                                    ...
                                    {
                                        // ... queue it
                                        queue.Enqueue("https://www.reuters.com" + hyperlink);
                                        validLinkCount++;
                                    }
                                }
                            }
